...
def seed_reviews():
    ...
    reviews = [
        Review(stars=0, chapter_id=1, content="This is the worst thing I've ever read! An insult to thought itself!"),
        Review(stars=5, chapter_id=1, content="This is the best thing I've ever read! It really makes you think!"),

        Review(stars=3, chapter_id=1, content='"The Unveiling of Secrets" is an intriguing chapter with an air of suspense. While the unexpected twists add depth to the story, the rushed pacing and lack of clarity in the plot execution hinder the overall impact. With improved pacing and clearer explanations, this chapter could have been more immersive and captivating. Despite its flaws, "The Unveiling of Secrets" succeeds in keeping readers engaged and curious about what lies ahead in the narrative.'),
